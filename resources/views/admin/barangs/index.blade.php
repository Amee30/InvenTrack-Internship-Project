<x-admin-layout>
    ...
    <div class="flex flex-col min-h-screen">
        <div class="flex-grow py-4 sm:py-8 mt-4">
            <div class="w-full mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="flex flex-col gap-4 mb-4 sm:mb-6">
                            ...
                            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                                <label for="categoryFilter"
                                    class="text-sm font-medium text-gray-700 dark:text-gray-300 whitespace-nowrap sm:min-w-fit">
                                    Filter:
                                </label>
                                <form method="GET" action="{{ route('admin.barang.index') }}" id="filterForm"
                                    class="flex flex-wrap items-center gap-2 flex-1">
                                    <select id="categoryFilter" name="kategori"
                                        onchange="document.getElementById('filterForm').submit()"
                                        class="flex-1 sm:flex-none bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400 rounded-md shadow-sm text-sm py-2 px-3 sm:min-w-[180px]">
                                        <option value="all"
                                            {{ !request('kategori') || request('kategori') == 'all' ? 'selected' : '' }}>
                                            All Categories
                                        </option>
                                    ...
                                    <select id="locationFilter" name="location_id"
                                        onchange="document.getElementById('filterForm').submit()"
                                        class="flex-1 sm:flex-none bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-teal-500 dark:focus:border-teal-400 focus:ring-teal-500 dark:focus:ring-teal-400 rounded-md shadow-sm text-sm py-2 px-3 sm:min-w-[180px]">
                                        <option value="all"
                                            {{ !request('location_id') || request('location_id') == 'all' ? 'selected' : '' }}>
                                            All Locations
                                        </option>
                                    ...
                                    @if (
                                        (request('kategori') && request('kategori') !== 'all') ||
                                            (request('location_id') && request('location_id') !== 'all'))
                            ...
                            @if (
                                ...
                                <div class="flex flex-wrap gap-2">
                                    @if (request('kategori') && request('kategori') !== 'all')
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                                    ...
                                    @if (request('location_id') && request('location_id') !== 'all')
                                        <span
                                            class="inline-flex items-center px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-teal-100 dark:bg-teal-900 text-teal-800 dark:text-teal-200">
                                            <svg class="h-4 w-4 mr-1" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            ...
                                            Location: {{ $locations->find(request('location_id'))?->name ?? '-' }}
                                        </span>
                                    @endif
                                </div>
                            @endif
                                    ...
                                    @forelse($barangs as $barang)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                ...
                                                @else
                                                    <div
                                                        class="w-20 h-20 bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center mx-auto">
                                            ...
                                            <td class="px-6 py-4">
                                                <span
                                                    class="flex justify-center items-center px-2.5 py-0.5 rounded-full text-sm font-medium text-gray-900 dark:text-white">
                                                    {{ $barang->kategori }}
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 text-center">
                                                <span
                                                    class="flex justify-center items-center px-2.5 py-0.5 rounded-full text-sm font-medium 
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                                <div class="flex items-center justify-center space-x-3">
                                                    <!-- Details Button -->
                                                    <button type="button" onclick="showModal('{{ $barang->id }}')"
                                                    ...
                                                    <form
                                                        action="{{ route('admin.barang.toggleVisibility', $barang->id) }}"
                                                        method="POST" class="inline-flex">
                                                        @csrf
                                                        <button type="submit"
                                                            class="p-1 border border-gray-300 dark:border-gray-600 rounded-full {{ $barang->is_hidden ? 'text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500' : 'text-green-600 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-900 hover:border-green-400 dark:hover:border-green-500' }} transition-colors duration-200"
                                                            title="{{ $barang->is_hidden ? 'Show Item' : 'Hide Item' }}">
                                                            @if ($barang->is_hidden)
                                            ...
                                            <td colspan="5"
                                                ...
                                                <div class="flex flex-col items-center">
                                                    <svg class="w-12 h-12 text-gray-300 dark:text-gray-600 mb-4"
                                                        ...
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="1"
                                                            d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2M4 13h2m13-8l-4 4-3-3-6 6">
                                                        </path>
                                                    </svg>
                                                    <h3 class="text-sm font-medium text-gray-900 dark:text-white mb-1">
                                                        @if (request('kategori') && request('kategori') !== 'all')
                                                            No items found in "{{ request('kategori') }}" category
                                                        @elseif(request('location_id') && request('location_id') !== 'all')
                        ...
                        <div class="lg:hidden space-y-4">
                            @forelse($barangs as $barang)
                                <div
                                    ...
                                    <!-- Image di atas -->
                                    <div
                                        class="flex justify-center mb-3 pb-3 border-b border-gray-200 dark:border-gray-600">
                                        @if ($barang->foto)
                                            <img src="{{ asset('storage/' . $barang->foto) }}"
                                                alt="{{ $barang->nama_barang }}"
                                        ...
                                        @else
                                            <div
                                                class="w-32 h-32 bg-gray-200 dark:bg-gray-600 rounded-lg flex items-center justify-center">
                                    ...
                                    <div class="mb-3 pb-3 border-b border-gray-200 dark:border-gray-600">
                                        <h4
                                            class="text-base font-semibold text-gray-900 dark:text-white break-words mb-2 text-center">
                                            {{ $barang->nama_barang }}</h4>
                                        <div class="flex justify-center">
                                            <span
                                                class="inline-block px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                                                {{ $barang->kategori }}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <!-- Toggle Visibility Button -->
                                        <form action="{{ route('admin.barang.toggleVisibility', $barang->id) }}"
                                            method="POST" class="flex-1 min-w-[calc(50%-0.25rem)]">
                                            @csrf
                                            <button type="submit"
                                                class="w-full inline-flex items-center justify-center px-3 py-2 {{ $barang->is_hidden ? 'bg-gray-500 hover:bg-gray-700 dark:bg-gray-600 dark:hover:bg-gray-700' : 'bg-green-500 hover:bg-green-700 dark:bg-green-600 dark:hover:bg-green-700' }} text-white text-xs font-semibold rounded-lg transition-colors">
                                                @if ($barang->is_hidden)
                                                    <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @if ($barangs->hasPages())
                    <div
                        class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mt-4 border border-gray-200 dark:border-gray-700">
                        <div class="p-4">
                            {{ $barangs->appends(['kategori' => request('kategori'), 'location_id' => request('location_id')])->links() }}
                        </div>
                    </div>
                @endif
            </div>
    ...
    <div id="detailModal"
        ...
        <div
            class="relative top-4 sm:top-20 mx-auto p-4 sm:p-5 border border-gray-200 dark:border-gray-700 w-11/12 max-w-4xl shadow-lg rounded-md bg-white dark:bg-gray-800 my-4">
            <div class="flex flex-col">
                <div
                    class="flex justify-between items-center pb-3 sm:pb-4 border-b border-gray-200 dark:border-gray-700 mb-3 sm:mb-4">
                    <h3 class="text-lg sm:text-xl font-medium text-gray-900 dark:text-white" id="modalTitle">Item
                        Details</h3>
                    <button class="text-gray-400 hover:text-gray-500 dark:text-gray-500 dark:hover:text-gray-400 p-1"
                        onclick="closeModal()">
                ...
                <div id="modalLoading" class="text-center py-8">
                    <svg class="animate-spin h-8 w-8 mx-auto text-blue-600 dark:text-blue-400"
                ...
                <div id="modalContent" class="mt-2 hidden">
                    <div class="flex flex-col md:flex-row gap-4 sm:gap-6">
                        ...
                        <div class="md:w-1/2">
                            <div class="space-y-3 sm:space-y-4">
                                <div>
                                    ...
                                    <p class="text-base sm:text-lg font-semibold text-gray-900 dark:text-white break-words"
                                        id="productName">-</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Manufacturer
                                    </p>
                                    <p class="text-sm sm:text-base text-gray-900 dark:text-white break-all"
                                        id="productManufacturer">-</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    <p class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Serial Number
                                    </p>
                                    <p class="text-sm sm:text-base text-gray-900 dark:text-white break-all"
                                        id="productSerial">-</p>
                                </div>
                        ...
                        <div class="md:w-1/2">
                            <div
                                class="bg-gray-50 dark:bg-gray-700 p-3 sm:p-4 rounded-lg border border-gray-200 dark:border-gray-600">
                                ...
                                <div id="qrCodeContainer" class="flex flex-col items-center">
                                    <div
                                        class="bg-white dark:bg-white p-2 sm:p-3 rounded shadow-sm mb-2 sm:max-w-none">
                                        <!-- QR Code SVG will be loaded here -->
                                    </div>
                                    <p class="text-xs font-mono text-gray-600 dark:text-gray-400 break-all text-center"
                                        id="qrCodeText">-</p>
                                </div>
                            ...
                            <!-- Usage Info -->
                            <div
                                class="mt-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 p-3 rounded-lg">
                                <h5 class="font-semibold text-blue-900 dark:text-blue-200 text-xs sm:text-sm mb-2">How
                                    to Use:</h5>
                ...
                <div class="mt-4 border-t border-gray-200 dark:border-gray-700 pt-3 sm:pt-4">
                    <button
                        class="px-4 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-white text-sm font-medium rounded-md w-full sm:w-auto transition-colors"
                        onclick="closeModal()">
                        Close
                    </button>
                </div>
        ...
        function showModal(id) {
            ...
            fetch(`/admin/barang/${id}/details`)
                ...
                .then(data => {
                    ...
                    document.getElementById('productCreated').innerText = data.created_at + ' (' + data
                        .created_at_diff + ')';
                    document.getElementById('productUpdated').innerText = data.updated_at + ' (' + data
                        .updated_at_diff + ')';

                    // Update stock with badge
                    const stockBadgeClass = data.stok > 0 ?
