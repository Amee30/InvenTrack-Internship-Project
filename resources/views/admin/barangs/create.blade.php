                ...
                <div
                    ...
                    <div class="p-6 text-gray-900 dark:text-white">
                        ...
                        <form method="POST" action="{{ route('admin.barang.store') }}" enctype="multipart/form-data"
                            ...
                            <div>
                                <label for="existing_item"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    Select Existing Item (Optional)
                                </label>
                                <select id="existing_item"
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_barang"
                                    ...
                                    type="text" name="nama_barang" :value="old('nama_barang')" required autofocus
                            ...
                            <div>
                                ...
                                <x-text-input id="manufacturer"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="text" name="manufacturer" :value="old('manufacturer')"
                            ...
                            <div>
                                ...
                                <x-text-input id="asset_tag"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="text" name="asset_tag" :value="old('asset_tag')"
                            ...
                            <div>
                                ...
                                <x-text-input id="stok"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="number" name="stok" :value="old('stok', 1)" required min="1"
                            ...
                            <div>
                                ...
                                <x-text-input id="source"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="text" name="source" :value="old('source')" required
