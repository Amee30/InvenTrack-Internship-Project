<x-admin-layout>
                        ...
                        <form method="POST" action="{{ route('admin.barang.update', $barang->id) }}"
                            ...
                            <div>
                                ...
                                <x-text-input id="nama_barang"
                                    ...
                                    type="text" name="nama_barang" :value="old('nama_barang', $barang->nama_barang)" required autofocus
                                ...
                                <select id="location_id" name="location_id"
                                    ...
                                    @foreach ($locations as $location)
                                        <option value="{{ $location->id }}"
                                            {{ old('location_id', $barang->location_id) == $location->id ? 'selected' : '' }}>
                                            {{ $location->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="manufacturer"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="text" name="manufacturer" :value="old('manufacturer', $barang->manufacturer)"
                            ...
                            <div>
                                ...
                                <x-text-input id="model"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="text" name="model" :value="old('model', $barang->model)"
                            ...
                            <div>
                                ...
                                <x-text-input id="serial_number"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="text" name="serial_number" :value="old('serial_number', $barang->serial_number)"
                            ...
                            <div>
                                ...
                                <x-text-input id="asset_tag"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="text" name="asset_tag" :value="old('asset_tag', $barang->asset_tag)"
                            ...
                            <div>
                                ...
                                <x-text-input id="stok"
                                    class="block mt-1 w-full bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400"
                                    type="number" name="stok" :value="old('stok', $barang->stok)" required min="0"
                            ...
                            <div>
                                ...
                                <div id="dropzone"
                                    class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg hover:border-gray-400 dark:hover:border-gray-500 transition-colors cursor-pointer">
                                    <div class="space-y-1 text-center">
                                        ...
                                        <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, JPEG up to 2MB
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div id="imagePreview" class="mt-4 hidden">
                                    <img id="preview"
                                        class="rounded-lg border border-gray-300 dark:border-gray-600 max-h-64 mx-auto"
                                        alt="Preview" />
                                    <button type="button" onclick="removeImage()"
                                        class="mt-2 mx-auto block text-sm text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300">
                                        Remove Image
                                    </button>
                                </div>
    ...
    <script>
        ...
        function unhighlight(e) {
            dropzone.classList.remove('border-indigo-500', 'dark:border-indigo-400', 'bg-indigo-50',
